...
class Help():
    def __init__(self):
        big_font = pygame.font.SysFont('serif', 30, True)
        self.small_font = pygame.font.SysFont('arial', 24) # этот шрифт надо помнить и для постоянной надписи
        text1 = big_font.render("Немного про управление: ", 1, C_YELLOW)
        text2 = self.small_font.render("Влево: «а» или стрелка влево ", 1, C_YELLOW)
